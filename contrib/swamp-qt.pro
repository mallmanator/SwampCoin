...
RESOURCES += src/qt/swamp.qrc src/qt/swamp_locale.qrc

TRANSLATIONS += src/qt/locale/swamp_bg.ts \
                src/qt/locale/swamp_de.ts \
                src/qt/locale/swamp_en.ts \
                src/qt/locale/swamp_es.ts \
                src/qt/locale/swamp_fi.ts \
                src/qt/locale/swamp_fr.ts \
                src/qt/locale/swamp_it.ts \
                src/qt/locale/swamp_ja.ts \
                src/qt/locale/swamp_pl.ts \
                src/qt/locale/swamp_pt.ts \
                src/qt/locale/swamp_ru.ts \
                src/qt/locale/swamp_sk.ts \
                src/qt/locale/swamp_sv.ts \
                src/qt/locale/swamp_vi.ts \
                src/qt/locale/swamp_zh_CN.ts \
                src/qt/locale/swamp_zh_TW.ts
