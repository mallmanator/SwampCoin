...
*Setup instructions for a gitian build of SWAMP using a Debian VM or physical system.*
...
Clone the git repositories for swamp and gitian and then checkout the swamp version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/swamp-crypto/swamp.git
cd swamp
...
Follow the instructions in [doc/release-process.md](release-process.md) in the swamp repository
...
To build SWAMP (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the swamp repository.
...
```bash
    ...
    From https://github.com/swamp-crypto/swamp
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/swamp-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/swamp-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/swamp-build.assert
```
...
[swamp/gitian.sigs](https://github.com/swamp-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
