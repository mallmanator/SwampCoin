...
In order to support loading of multiple wallets in swamp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is swamp.cpp.
...
Changes to swamp.cpp
----------------------
swamp.cpp is the entry point into swamp-qt, and as such, will require some minor modifications to provide hooks for
