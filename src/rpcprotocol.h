...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! SWAMP is not connected
...
public:
    ...
    bool connect(const std::string& server, const std::string& port)
    {
        ...
        try {
            ...
            // If we at first don't sswampeed, try blanket lookup (IPv4+IPv6 independent of configured interfaces)
