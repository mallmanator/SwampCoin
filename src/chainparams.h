...
public:
    ...
    const std::vector<unsigned char>& xSWAMPDevKey() const { return vSWAMPDevKey; }
    const std::vector<unsigned char>& xSWAMPFundKey() const { return vSWAMPFundKey; }
...
protected:
    ...
    std::vector<unsigned char> vSWAMPDevKey;
    std::vector<unsigned char> vSWAMPFundKey;
    int nDevFee;
    int nFundFee;
    int nDefaultPort;
