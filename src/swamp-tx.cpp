...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NWO Core swamp-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  swamp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NWO transaction") + "\n" +
                               "  swamp-tx [options] -create [commands]   " + _("Create hex-encoded NWO transaction") + "\n" +
                               "\n";
