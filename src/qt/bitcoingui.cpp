...
QFontDatabase::addApplicationFont(":/fonts/swamp_font");

QString windowTitle = tr("SWAMP Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SWAMP Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about SWAMP Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SWAMP"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SWAMP Wallet help message to get a list with possible SWAMP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SWAMP client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("SWAMP Wallet"); // default title
