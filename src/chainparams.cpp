...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // SWAMP: 1 minute
        ...
        vSeeds.push_back(CDNSSeedData("45.32.217.164:31110", "45.32.217.164:31110"));     // Primary DNS Seeder
	vSeeds.push_back(CDNSSeedData("swampnode2.doesntexist.com", "swampnode2.doesntexist.com"));
        vSeeds.push_back(CDNSSeedData("swampnode3.doesntexist.com", "swampnode3.doesntexist.com"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 10;  // SWAMP: 10 seconds
        nLastPOWBlock = 1000;
        nMaturity = 15;
