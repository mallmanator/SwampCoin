...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "swamp.conf"));
    ...
    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty swamp.conf if it does not exist
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "swampd.pid"));
