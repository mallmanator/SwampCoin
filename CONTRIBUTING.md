...
The SWAMP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SWAMP Core project, and is not to be
confused with overall SWAMP Network Protocol consensus changes.

Whether a pull request is merged into SWAMP Core rests with the project merge
...
Patches that change SWAMP consensus rules are considerably more involved than
...
Where a patch set proposes to change the SWAMP consensus, it must have been
...
The project leader is the release manager for each SWAMP Core release.
