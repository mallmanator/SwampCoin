...
#   c) node1 mines 32 blocks, so now node 0 has 60001swamp, node 1 has 4250swamp, node2 has none.
#   d) node0 sends 601 swamp to node2, in two transactions (301 swamp, then 300 swamp).
